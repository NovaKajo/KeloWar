...
public class ParabolaController : MonoBehaviour
{
    ...
    {
        parabolaFly = new ParabolaFly(ParabolaRoot.transform,target);
    ...
    private void OnTriggerEnter(Collider other)
    {
      if(other.CompareTag("Wall"))
      {
          //Animation = false;
          //Debug.Log("hey");
            PoolManager.Pools["EnemyProjectiles"].Despawn(gameObject.transform, 0.05f);
      }
    ...
    public class ParabolaFly
    {
        ...
        public ParabolaFly(Transform ParabolaRoot,Transform target)
        {
